...
public class MainController {
    ...
    public String deleteAccount(HttpServletRequest request, HttpServletResponse response) {
        ...
        if ("Redirecting".equals(logout) && !JustChatApplication.adminUsername.equals(user.getUsername())) {
    ...
    public ResponseEntity<InputStreamResource> download(@RequestParam String fileId, HttpServletResponse response) {
        try {
            ...
            InputStreamResource resource = new InputStreamResource(
                    new FileInputStream(new File(JustChatApplication.uploadPath + "/" + info.getFileDataId())));
    ...
    public String uploadFile(HttpServletRequest request, @RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            File orgFile = new File(JustChatApplication.uploadPath + "/" + UUID.randomUUID());
            ...
            if (isImg) {
                File imgPrevFile = new File(JustChatApplication.uploadPath + "/" + UUID.randomUUID());
                byteUtils.makeThumbnailImage(JustChatApplication.imgThumbnailFormat, 500, new FileInputStream(orgFile), new FileOutputStream(imgPrevFile), true, true);
